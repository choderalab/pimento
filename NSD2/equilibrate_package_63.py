...
print("Loading PDB...")
pdb = PDBFile(pdb_filename) #63 can't specify extraParticleIdentifier

topology = pdb.topology
positions = pdb.positions

#63 can't specify extraParticleIdentifier
for atom in topology.atoms():
    if atom.element.symbol == 'D':
        atom.element = None
...
simulation.minimizeEnergy(tolerance=1*u.kilojoules_per_mole)
