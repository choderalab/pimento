...
X = df.pivot_table(index="tica__n_components", columns="cluster__n_clusters", values="mean_test_score")
sns.heatmap(X, square=True, cmap='rainbow')

Y = df[["cluster__n_clusters", "tica__n_components", "mean_test_score"]].sort("mean_test_score")
Y
